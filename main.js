...
const INSTALLER32_VERSION = '2025-02-09';
const INSTALLER32_URL = `https://github.com/msys2/msys2-installer/releases/download/nightly-i686/msys2-base-i686-${INSTALLER32_VERSION.replace(/-/g, '')}.sfx.exe`;
const INSTALLER32_CHECKSUM = '532d17c817f9447df48e467e04c7eaadd0d60265fb66fae1e3b65e61b37ce9ab';
  ...
  try {
    ...
    if (input.release) {
      ...
      if (!cachedInstall) {
        ...
        msysRootDir = path.join('C:', `msys${input.bitness}`);
    }
